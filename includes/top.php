...
<header class="font5 fixed-top bg-black" id="header">
    <div class="d-flex flex-wrap border-bottom border-light">
        ...
        <div class="col-auto d-none d-md-block">
            ...
            <?php } ?>
            <a class="btn btn-sm fw-bolder text-light" href='https://discord.gg/gHaAxqC2Hw'><i class="fa-regular fa-circle-question"></i> Problemas?</a>
        </div>
        ...
        <div class="col-auto dropdown d-md-none">
            ...
            <div class="dropdown-menu dropdown-menu-dark" title="Menu" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item text-light" href='https://discord.gg/gHaAxqC2Hw'><i class="fa-regular fa-circle-question"></i> Problemas?</a>
                <?php if (isset($_SESSION["UserID"])) { ?>
