            ...
            <div class="card bg-black border-light">
                <div class="card-body">
                    <form class="needs-validation" method="post" novalidate autocomplete="off" id="criar">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-3">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label class="fs-4 fw-bold" for="trilha">Trilha (10% NEX!)</label>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="container p-0">
                                        ...
                                        <div class="p-2 m-1">
                                            ...
                                            <input class="form-control bg-black text-light border-light" id="pv" type="number" min="1" max="999" value="0" name="pv" required/>
                                            ...
                                            <input class="form-control bg-black text-light border-light" id="san" type="number" min="1" max="999" value="0" name="san" required/>
                                            <div class="invalid-feedback">Coloque sua sanidade maxima.</div>

                                            <label for="pe" class="fs-4 fw-bold">Pontos de Esforço (PE)</label><span>(Deixe 1 para calcular automaticamente)</span>
                                            <input id="pe" class="form-control bg-black text-light border-light" type="number" min="1" max="999" value="0" name="pe" required/>
                                            <div class="invalid-feedback">Adiciona um total de Pontos de Esforço.</div>
                        ...
                        <input type="hidden" value="<?php echo $id; ?>" name="convite">
                    </form>
                </div>
            </div>
        </main>
