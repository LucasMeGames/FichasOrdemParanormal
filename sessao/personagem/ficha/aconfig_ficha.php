...
if (isset($rqs)) {
	...
	switch ($rqs["foto_marca"]){
		default:
			...
			break;
		case 1:
			$elemento = "https://beta.fichasop.com/assets/img/Morte.png";
			break;
		case 2:
			$elemento = "https://beta.fichasop.com/assets/img/Sangue.png";
			break;
		case 3:
			$elemento = "https://beta.fichasop.com/assets/img/Energia.png";
			break;
		case 4:
			$elemento = "https://beta.fichasop.com/assets/img/Conhecimento.png";
			break;
		case 5:
			$elemento = "https://beta.fichasop.com/assets/img/Medo.png";
			break;
	}
	$nex = $rqs["nex"];
	$pp = $rqs["pp"];
