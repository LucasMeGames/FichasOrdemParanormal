        ...
        <div class="modal-content bg-black border-light">
            <form class="modal-body" id="formeditpri">
                ...
                <div class="m-2">
                    ...
                    <div class="input-group input-group-sm m-1">
                        <label for="eesqui" class="input-group-text border-info bg-black text-white border-end-0">Esquiva:</label>
                        <input id="eesqui" class="form-control border-info bg-black text-white border-start-0" min="0" max="50" type="number" name="esquiva" value="<?=$esquiva?>"/>
                    </div>
                </div>
                <div class="m-2">
