                                        ...
                                        <div class="col-md-6 my-2">
                                            <div class="card h-100 m-2 bg-black border-primary">
                                                <div class="text-start m-2">
                                                    <a class="btn btn-sm btn-outline-info" href="personagem/portrait?token=<?= $dl["token"]; ?>">Portrait</a>
                                                    <button type="button" class="btn btn-sm text-primary" data-bs-toggle="modal" data-bs-target="#configplayer" onclick="configplayer(<?= $dl["id"] ?>)"><i class="fa-solid fa-gear"></i></button>
                                                    <button type="button" class="btn btn-sm " title="Ficha está atualmente <?= $dl["public"] ? "Visivel" : "Invisivel" ?>">
                                                        <i class="fa-solid fa-eye<?= $dl["public"] ? " text-success" : "-slash text-danger" ?>"></i>
                                                    </button>
                                                </div>
                                                <div class="card-body">
                                                    <div class="card-title"><label for="missao[]" class="text-danger fs-4 fw-bold"><?= $dl["nome"]; ?></label>
                                                    </div>
                                                    <textarea id="missao[]" disabled class="bg-black text-white w-100"
                                                              style="height: 100px;"><?= $dl["historia"]; ?></textarea>
                                                    <div class="card-footer">
                                                        <a class="btn btn-outline-primary" href='personagem?token=<?= $dl["token"]; ?>'>Dar uma olhada - <?= $dl["nome"]; ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
