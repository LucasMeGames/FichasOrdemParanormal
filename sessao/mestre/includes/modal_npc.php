                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-out" role="tabpanel" aria-labelledby="pills-out-tab">
                        <div class="m-2">
                            ...
                            <textarea class="w-100 bg-black text-light" id="ataque" maxlength="1000" name="ataques" type="text"></textarea>
                        </div>
                        <div class="m-2">
                            <label class="fs-4" for="habilidades">Habilidades</label><br>
                            <textarea class="w-100 bg-black text-light" id="habilidades" maxlength="1000" name="habilidades" type="text"></textarea>
                        </div>
                        <div class="m-2">
                            <label class="fs-4" for="detalhes">Detalhes</label><br>
                            <textarea class="w-100 bg-black text-light" id="detalhes" maxlength="1000" name="detalhes" type="text"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="pills-eout" role="tabpanel" aria-labelledby="pills-out-tab">
                        <div class="m-2">
                            ...
                            <textarea class="w-100 bg-black text-light" maxlength="1000" id="eataque" name="ataques" type="text"></textarea>
                        </div>
                        <div class="m-2">
                            <label class="fs-4" for="ehabilidades">Habilidades</label>
                            <textarea class="w-100 bg-black text-light" maxlength="1000" id="ehabilidades" name="habilidades" type="text"></textarea>
                        </div>
                        <div class="m-2">
                            <label class="fs-4" for="edetalhes">Detalhes</label>
                            <textarea class="w-100 bg-black text-light" maxlength="1000" id="edetalhes" name="detalhes" type="text"></textarea>
                        </div>
                    </div>
                </div>
            </div>
