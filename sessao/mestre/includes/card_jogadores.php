    ...
    <div class="card bg-black border-light h-100">
        <div class="card-body p-0">
            ...
            <div class="row row-cols-lg-2 row-cols-1 g-2 p-2" id="fichasperson">
                <?php while ($fichaa = mysqli_fetch_assoc($q)) {
                    if ($fichaa["id_ficha"] > 0) {
                        $qf = $con->query("SELECT * FROM `fichas_personagem` WHERE `id` = '" . $fichaa["id_ficha"] . "'");
                            ...
                            <div class="card-body h-100 p-0" id="player<?= $ficha["id"] ?>">
                                <div class="card h-100 bg-black border-light">
                                    <div class="clearfix ms-1 my-1">
                                        <a class="btn btn-sm btn-outline-info float-start" href="./../personagem/portrait/?token=<?=$ficha["token"]?>">Portrait</a>
                                    ...
                                    <div class="card-body border-0 text-center">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="principal-<?= $ficha["id"] ?>"
                                                 role="tabpanel" aria-labelledby="aba-principal-<?= $ficha["id"] ?>"
                                                 tabindex="0">
                                                ...
                                                <div class="my-2 row px-3">
                                                    <strong class="col-6 p-0 text-start">Esforço: <?= $ficha["pe"] - $ficha["pea"]; ?>
                                                        /<?= $ficha["pe"]; ?> Usados</strong>
                                                    <strong class="col-6 p-0 text-end">Peso: <?= $espacosusados ?: "0" ?>
                                                        /<?= 5 * $ficha["forca"] ?: 2 ?></strong>
                                                </div>
                                            </div>
