        ...
        <div class="modal-content bg-black border-light">
            <div class="modal-body">
                ...
                <div class="m-3">
                    ...
                    <p>
                        Para usar algum atributo como, por exemplo, FORÇA basta adicionar "<code>|FOR|</code>".
                        Exemplos: Rolar 2d20 somando FORÇA, "<code>2d20+|FOR|</code>".
                    </p>
                    <p>
                        Para modificar os valores do atributo usando operações matemática, basta usar no módulo.
                        Exemplo: 2d10 mais o dobro de FORÇA, "<code>2d10+|FOR*2|</code>".
            ...
            <div class="modal-body">
                <div class="m-3">
                    ...
                    <div class="m-2">
                        ...
                        <input id="dnome" class="form-control bg-black  text-light " type="text" maxlength="20" name="nome"/>
                    </div>
                    <div class="m-2">
                        <label class="fs-4" for="ddado">Dados</label>
                        <input id="ddado" class="form-control bg-black  text-light" type="text" maxlength="20" name="dado" required/>
                    </div>
            ...
            <div class="modal-body">
                <div class="m-3">
                    ...
                    <div class="m-2">
                        ...
                        <input id="ednome" class="form-control bg-black  text-light" type="text" maxlength="20" name="nome"/>
                    </div>
                    <div class="m-2">
                        <label class="fs-4" for="eddado">Dados</label>
                        <input id="eddado" class="form-control bg-black  text-light" type="text" maxlength="20" name="dado" required/>
                    </div>
                    <div class="form-check form-switch">
...
<div class="position-fixed top-50 start-50 translate-middle">
    <div class="toast bg-black text-light border-dark" id="Toastdados" role="alert" data-bs-autohide="false" aria-live="assertive" aria-atomic="true">
        ...
        <div class="toast-body">
            <span class="font6 fs-1" id="resultado"></span>
